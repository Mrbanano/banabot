...
from banabot.cli.i18n import LANGUAGES, t
...
MODEL_SPECS: dict[str, dict[str, int]] = {
    "anthropic/claude-opus-4-5": {"max_context": 200000, "max_tokens": 32000},
    "anthropic/claude-sonnet-4-5": {"max_context": 200000, "max_tokens": 32000},
    "anthropic/claude-haiku-3-5": {"max_context": 200000, "max_tokens": 32000},
    "openai/gpt-4o": {"max_context": 128000, "max_tokens": 16384},
    "openai/gpt-4o-mini": {"max_context": 128000, "max_tokens": 16384},
    "openai/o1": {"max_context": 128000, "max_tokens": 100000},
    "deepseek/deepseek-chat": {"max_context": 64000, "max_tokens": 8192},
    "deepseek/deepseek-reasoner": {"max_context": 64000, "max_tokens": 16384},
    "google/gemini-2.5-pro": {"max_context": 1000000, "max_tokens": 8192},
    "google/gemini-2.5-flash": {"max_context": 1000000, "max_tokens": 8192},
    "gemini/gemini-2.5-pro": {"max_context": 1000000, "max_tokens": 8192},
    "gemini/gemini-2.5-flash": {"max_context": 1000000, "max_tokens": 8192},
    "groq/llama-3.3-70b-versatile": {"max_context": 128000, "max_tokens": 8192},
    "groq/llama-3.1-8b-instant": {"max_context": 128000, "max_tokens": 8192},
    "moonshot/kimi-k2.5": {"max_context": 1000000, "max_tokens": 32000},
    "siliconflow/Qwen/Qwen2.5-72B-Instruct": {"max_context": 32000, "max_tokens": 8192},
    "siliconflow/deepseek-ai/DeepSeek-V3": {"max_context": 64000, "max_tokens": 8192},
}
...
def _select_timezone(config: Config, lang: str) -> str:
    ...
    tz = inquirer.select(
        ...
        if config.timezone in dict(POPULAR_TIMEZONES)
...
def _prompt_field(
    ...
    # list[str]
    if annotation == list[str] or (
        hasattr(annotation, "__origin__") and getattr(annotation, "__origin__", None) is list
    ):
...
def config_wizard(config: Config) -> Config:
    ...
    if provider:
        ...
        console.print(
            f"[dim]✓ {t('step_model_tokens_set', lang, tokens=model_specs['max_tokens'])}[/dim]"
        )
