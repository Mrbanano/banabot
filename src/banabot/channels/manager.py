...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.telegram.enabled:
            try:
                from banabot.channels.telegram import TelegramChannel
        ...
        if self.config.channels.whatsapp.enabled:
            try:
                from banabot.channels.whatsapp import WhatsAppChannel
        ...
        if self.config.channels.discord.enabled:
            try:
                from banabot.channels.discord import DiscordChannel
        ...
        if self.config.channels.feishu.enabled:
            try:
                from banabot.channels.feishu import FeishuChannel
        ...
        if self.config.channels.mochat.enabled:
            try:
                from banabot.channels.mochat import MochatChannel
        ...
        if self.config.channels.dingtalk.enabled:
            try:
                from banabot.channels.dingtalk import DingTalkChannel
        ...
        if self.config.channels.slack.enabled:
            try:
                from banabot.channels.slack import SlackChannel
        ...
        if self.config.channels.qq.enabled:
            try:
                from banabot.channels.qq import QQChannel
