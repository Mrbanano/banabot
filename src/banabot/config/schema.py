...
class SearchProvidersConfig(Base):
    ...
    def get_active_provider(self, default_provider: str) -> tuple[str, SearchProviderConfig]:
        """Return the active provider: default if configured and valid, else first available."""
        from banabot.agent.tools.search_registry import SEARCH_PROVIDERS, find_search_provider
...
class Config(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="BANABOT_", env_nested_delimiter="__")
