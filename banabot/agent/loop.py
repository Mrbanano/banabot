...
from banabot.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from banabot.agent.tools.shell import ExecTool
from banabot.agent.tools.web import WebSearchTool, WebFetchTool
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from banabot.agent.tools.mcp import connect_mcp_servers
