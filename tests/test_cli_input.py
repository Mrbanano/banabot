...
def mock_prompt_session():
    ...
    with patch("banabot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("banabot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("banabot.cli.commands.PromptSession") as MockSession, \
         patch("banabot.cli.commands.FileHistory") as MockHistory, \
