...
from banobot.config.schema import TelegramConfig
    ...
    async def _on_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        if media_file and self._app:
            try:
                ...
                media_dir = Path.home() / ".banobot" / "media"
                ...
                if media_type == "voice" or media_type == "audio":
                    from banobot.providers.transcription import GroqTranscriptionProvider
