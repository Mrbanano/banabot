...
from banobot.providers.base import LLMProvider
from banobot.agent.context import ContextBuilder
from banobot.agent.tools.registry import ToolRegistry
from banobot.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from banobot.agent.tools.shell import ExecTool
from banobot.agent.tools.web import WebSearchTool, WebFetchTool
from banobot.agent.tools.message import MessageTool
from banobot.agent.tools.spawn import SpawnTool
from banobot.agent.tools.cron import CronTool
from banobot.agent.memory import MemoryStore
from banobot.agent.subagent import SubagentManager
...
class AgentLoop:
    ...
    def __init__(
        ...
        from banobot.config.schema import ExecToolConfig, WebSearchConfig
    ...
    async def _connect_mcp(self) -> None:
        ...
        from banobot.agent.tools.mcp import connect_mcp_servers
